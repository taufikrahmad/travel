	...
	<div id="wrapper">
		<header id="header" class="default-white-header header-v2">
			<div class="container-fluid">
				<div class="logo">
					<a href="index.html">
						<img class="normal" src="<?=base_url()."assets/img/logos/logo.png"?>" alt="logo">
						<img class="gray-logo" src="<?=base_url()."assets/img/logos/logo.png"?>" alt="logo">
					</a>
				</div>
                    ...
                    <div class="collapse navbar-collapse" id="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        ...
                                        ?>
                                        <li><a href="<?=base_url()?>index.php/front_catalog/index/INT/<?=$itr->id?>"><?=$itr->nama?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </li>
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        ...
                                        ?>
                                        <li><a href="<?=base_url()?>index.php/front_catalog/index/UMH/<?=$umh->id?>"><?=$umh->nama?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </li>
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        ...
                                        ?>
                                        <li><a href="<?=base_url()?>index.php/front_catalog/index/SPT/<?=$spt->id?>"><?=$spt->nama?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="visible-xs visible-sm">
																					...
																					<?php
																						if(number_format($this->session->CustomerLogin)==1){
																					?>
																					<span class="text"><?=$this->session->CustomerUserName?></span>
																					<?php
																						}else{
																					?>
                            ...
                            <li class="visible-xs visible-sm nav-visible dropdown last-dropdown">
                                <a href="my-cart.html" data-toggle="dropdown">
                                    ...
                                    <span class="text hidden-xs hidden-sm"><?=$CartItems;?></span>
                                </a>
                                <div class="dropdown-menu dropdown-md">
                                                                                        <div class="drop-wrap cart-wrap">
                                                                                            ...
                                                                                            <ul class="cart-list">
																								...
																								<li>
																									<div class="text-holder">
																										<span class="amount">x <?=$items['qty']; ?></span>
																									<div class="text-wrap">
																										<strong class="name"><a href="#"><?=$items['name']; ?></a></strong>
																										<span class="price"><?=$curr." ".$items['price']; ?></span>
																									</div>
																									</div>
																								</li>
																								<?php
																							...
																							<div class="footer">
																								<?php echo anchor('Cart','View cart',array('class'=>'btn btn-primary'));?>
																							</div>
                                                                                        </div>
                                                                                    </div>
                            </li>
