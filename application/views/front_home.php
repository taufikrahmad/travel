...
?>
            ...
            <main id="main">
                        ...
                        <div class="content-holder">
                            <div class="row db-3-col">
                                ...
                                <article class="col-sm-6 col-md-4 article has-hover-s3">
                                    <div class="img-wrap">
                                        <a href="#">
                                            <img src="<?=base_url().'assets/img/'.$row->pict?>" height="215" width="370" alt="image description">
                                        </a>
                                        <div class="img-caption text-uppercase"><?=$row->nama_paket?></div>
                                        <div class="hover-article">
                                            ...
                                            <div class="info-footer">
                                                <span class="price">from <span><?=$row->currency?> <?=number_format($row->price,2)?></span></span>
												<?php echo anchor('TourDetil/Package/'. $row->id,'Explore',array('class'=>'link-more')); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <h3><a href="#"><?=$row->nama_paket?></a></h3>
                                    <p>
                ...
                <section class="content-block article-boxed">
                    <div class="container">
                        <header class="content-heading">
                            <h2 class="main-heading">THE BLOG</h2>
                            <div class="seperator"></div>
                        </header>
                        <div class="content-holder content-boxed">
                            <div class="row db-3-col">
                                <article class="col-sm-6 col-md-4 article has-hover-s1">
                                    <div class="thumbnail">
                                        <div class="img-wrap">
                                            <img src="assets/img/listing/img-07.jpg" height="228" width="350" alt="image description">
                                        </div>
                                        <h3 class="small-space"><a href="tour-detail.html">WAE REBO : DESA DENGAN PENGALAMAN UNIK</a></h3>
                                        <span class="info">June, 09 2016</span>
                                        <aside class="meta">
                                            
                                        </aside>
                                        <p>Satu minggu yang lalu saya mengunjungi desa adat Wae Rebo, di Manggarai Barat, Flores. Desa ini terkenal sebagai salah satu tempat wisata karena memiliki keunikan yang beragam; mulai dari masyarakat, rumah adat, cara menujunya dan yang pasti alamnya.</p>
                                        <a href="tour-detail.html" class="btn btn-default">More</a>
                                    </div>
                                </article>
                                <article class="col-sm-6 col-md-4 article has-hover-s1">
                                    <div class="thumbnail">
